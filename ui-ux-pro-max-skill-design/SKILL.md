---
name: ui-ux-pro-max-skill-design
description: Design system skill for ui-ux-pro-max-skill. Activate when building UI components, pages, or any visual elements. Provides exact color tokens, typography scale, spacing grid, component patterns, and craft rules. Read references/DESIGN.md before writing any CSS or JSX.
---

# ui-ux-pro-max-skill Design System

You are building UI for **ui-ux-pro-max-skill**. Light-themed, neutral palette, sans-serif typography (sans-serif), compact density on a 4px grid, flat elevation (no shadows).
...
- Creating new components, pages, or visual elements for ui-ux-pro-max-skill
- Writing CSS, Tailwind classes, styled-components, or inline styles
- Building page layouts, templates, or responsive designs
- Reviewing UI code for design consistency
- The user mentions "ui-ux-pro-max-skill" design, style, UI, or theme
